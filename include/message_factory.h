...
public:
    ...
    static std::shared_ptr<rpc_msg> bbq_syncp_prechange_resp(uint32_t token, uint32_t synclatency, uint32_t result);
    static std::shared_ptr<rpc_msg> bbq_syncp_syncchange(uint32_t token);
    static std::shared_ptr<rpc_msg> bbq_syncp_syncchange_resp(uint32_t token, uint32_t result);
    ...
    static std::shared_ptr<rpc_msg> bbq_syncp_postchange_resp(uint32_t token, uint32_t result);
