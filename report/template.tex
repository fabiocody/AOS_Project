...
\documentclass[11pt, english, parskip=half]{scrartcl}
...
\horrule{0.5pt} \\[0.4cm]
\LARGE \textbf{BarbequeRTRM\\ Google Protocol Buffer based communication} \\[.5cm] % The assignment title
\large [ Coding Project ] \\ % Pick one: Monography and Coding Project
\horrule{2pt} \\[0.5cm]
\vfill
\author{}
\begin{tabular}{r l}
\textbf{Student} & Fabio Codiglioni \\
\textbf{ID} & 919897 \\[0.5cm]
